                ...
                <table class="table align-items-center justify-content-center mb-0">
                    <thead>
                        <tr>
                            ...
                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Fabricante</th>
                    ...
                    <tbody>
                        ...
                        $consulta = "CALL sp_mostrarFabricante"; //"SELECT * FROM fabricante";
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a target="_self" href="acciones/edicionfabricante.php?id=<?php echo $fila["codigo"] ?>">
